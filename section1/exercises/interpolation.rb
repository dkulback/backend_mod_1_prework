...
p "In a predicatable result, the #{slow_poke} beat the #{speedy}!!" * 8
...
coffee_flavor ="with oat milk"
coffee_temp = "hot"

p "my coffee order is a #{coffee_type} #{coffee_flavor} and always #{coffee_temp}."
